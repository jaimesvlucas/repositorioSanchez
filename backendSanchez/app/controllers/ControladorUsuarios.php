...
class ControladorUsuarios {
    ...
    function getConexion(){
        $this->dbPDO = null;
        try{
          $this->dbPDO = new PDO('mysql:host='.MYSQL_HOST.';dbname='.MYSQL_BD,MYSQL_USER,MYSQL_PASS);
    ...
    public function subirAvatar() {
      ...
      if(isset($_FILES['imagen'])) {
        ...
        if( !(strpos($mime, "jpeg") || strpos($mime, "png")) || ($size > 400000) ) {
          ...
          $ruta = ROOT."app/images/".$nombreFoto;
          ...
          $imgFind = ROOT."app/images/p-".IDUSER."-*";
          ...
          if(move_uploaded_file($rutaTemp,$ruta)) {
            ...
            $imgSRC = "http://localhost/repositorioSanchez/backendSanchez/app/images/".$nombreFoto;
